...
func TestSpecVersionHandler(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/imua/node/spec-version", nil)
...
func TestNodeHandler(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/imua/node", nil)
	w := httptest.NewRecorder()
...
func TestHealthHandler(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodGet, "/imua/node/health", nil)
			w := httptest.NewRecorder()
...
func TestServicesHandler(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodGet, "/imua/node/services", nil)
			w := httptest.NewRecorder()
...
func TestServiceHealthHandler(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/imua/node/services/123/health", nil)
	w := httptest.NewRecorder()
